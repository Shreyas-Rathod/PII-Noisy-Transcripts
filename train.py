...
def parse_args():
    ...
    # DEFAULT MODEL UPDATED: MiniLM
    ap.add_argument("--model_name", default="microsoft/MiniLM-L6-v2")

    ap.add_argument("--train", default="data/train.jsonl")
    ap.add_argument("--dev", default="data/dev.jsonl")
    ap.add_argument("--out_dir", default="out")
    ap.add_argument("--batch_size", type=int, default=8)     # smaller batch helps
...
def main():
    ...
    warmup_steps = int(0.2 * total_steps)      # increased warmup
